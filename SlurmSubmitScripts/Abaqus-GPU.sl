...
abaqus job=BigCavity_FullDisk input=BigCavity_FullDisk.inp cpus=$SLURM_CPUS_PER_TASK gpus=2 -verbose 1 standard_parallel=all mp_mode=threads interactive
######################################################
